...
//        canvas.drawArc(mRectF, mSweepAngle * mPercent, mSweepAngle - mSweepAngle * mPercent + 2, false, mBgArcPaint);
        canvas.drawArc(mRectF,2, mSweepAngle* totalProgress + 2, false, mBgArcPaint);

        mBgArcPaint2 = new Paint();
        mBgArcPaint.setAntiAlias(antiAlias);
        ...
        if (mPercent != 0)
            canvas.drawArc(mRectF, mSweepAngle * mPercent, mSweepAngle - mSweepAngle * mPercent + 2, false, mBgArcPaint);
        Log.i("jiang", "mpercent = " + mPercent + "   mSweepAngle * mPercent = "+ mSweepAngle * mPercent);
        //外 型圆弧
...
//        canvas.rotate(mStartAngle, mCenterPoint.x, mCenterPoint.y);
//        canvas.drawArc(mRectF, mSweepAngle * mPercent, mSweepAngle - mSweepAngle * mPercent + 2, false, mBgArcPaint);
        canvas.drawArc(mOutRectF,2, mSweepAngle*totalProgress + 2, false, mArcOutPaint);
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.rotate(mSweepAngle- mStartAngle, mCenterPoint.x, mCenterPoint.y);
